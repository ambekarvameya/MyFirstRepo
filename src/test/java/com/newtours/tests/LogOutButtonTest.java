...
public class LogOutButtonTest extends WebDriverTestCase {
	...
	public void backToFlightsTest()
	{
		...
		flightConfirmationPage.clickLogOutButton();
		Validator.verifyThat(getDriver().getCurrentUrl(), Matchers.equalTo(getProperty("signonpage")));
